        ...
        return {
            ...
            serialize() {
                ...
                return {
                    ...
                    calcArea: self.calcArea,
                    longDiameter: self.longDiameter,
                    shortDiameter: self.shortDiameter,
                    value: {
...
const HtxPolygonView = ({ item }) => {
    ...
    function renderLine({ points, idx1, idx2, closed }) {
        ...
        return (
            ...
            >
                <Line lineJoin="round" opacity={1} points={flattenedPoints} hitStrokeWidth={20} {...lineProps} />
            </Group>
        );
    }
